...
def main() -> None:
    ...
    # Each observation i is known at bar i+1 close. Event can only alter the subsequent return.
    ...
    # Event relevance: compare mean next-24h mean absolute hourly return after events
    # with the unconditional rolling 24h counterpart. Only complete windows count.
