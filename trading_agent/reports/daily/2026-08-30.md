# Relatorio diario do agente — 2026-08-30
...
![Historico das carteiras](2026-08-30-grafico.svg)

_Grafico do historico (base 100 no inicio de cada carteira): `2026-08-30-grafico.svg` — o mais recente fica sempre em `GRAFICO_ATUAL.svg`._
...
| NAV | $57,203.32 |
| Retorno do dia | -2.10% |
| Retorno desde inicio (2026-08-06) | +14.41% |
| Benchmark BTC | +20.76% |
| **Alfa vs BTC** | **-6.35%** |
| Caixa | $2,930.57 |
| Regime | risco ligado |
...
| Ativo | Qtd | Preco | Valor | Peso |
|---|---|---|---|---|
| BTC | 0.373424 | $77,791.15 | $29,049.10 | 50.8% |
| ZEC | 10.6877 | $838.36 | $8,960.18 | 15.7% |
| ENA | 57806.2 | $0.15 | $8,560.52 | 15.0% |
| SYN | 80373.1 | $0.10 | $7,702.95 | 13.5% |
...
| ADA | nao bate o benchmark (-0.3% <= +16.5%) |
...
| NAV | R$ 50,805.44 |
| Retorno do dia | +0.02% |
| Retorno desde inicio (2026-08-06) | +1.61% |
| Benchmark IBOV | +0.07% |
| Benchmark CDI | +0.78% |
| **Alfa vs o maior (CDI)** | **+0.83%** |
| Caixa | R$ 682.16 |
...
> Call vendida (premio modelado): strike R$ 177.20, vence 2026-09-05, premio R$ 2.3314/un, valor atual da obrigacao R$ 24.20
