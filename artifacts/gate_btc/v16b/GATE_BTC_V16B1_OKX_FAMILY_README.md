...
Scientific inheritance: V16B signal universe, 18 features, model, score, liquidity floor, portfolio construction, 13-week/20%/1x risk rule, Thursday/Friday clock, 15 bps primary cost, 30/50 bps stress. V16B.1 does not inherit prospective cycles or risk history from the parent because the short execution venue changed.

Execution change: longs remain Binance Spot USDT. Shorts are exact OKX USDT-settled live SWAP instruments selected causally from the frozen ascending short ranking. Funding and short-price evidence are official OKX only. No third-party substitutions.
