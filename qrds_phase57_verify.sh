...
echo "[QRDS][Phase57] Running focused tests..."
python -m pytest tests/unit/test_phase57_canonical_journal_input_validator_research_only.py -q
echo "[QRDS][Phase57] Running full suite..."
python -m pytest -q
echo "PHASE57_CANONICAL_JOURNAL_INPUT_VALIDATOR_RESEARCH_ONLY_READY_RESEARCH_ONLY"
