...
from crypto_decision_lab.scripts.phase193_full_suite_shard_b_execution_research_only import (
    LOCKS,
    load_phase193_artifact,
)
...
def test_phase193_full_suite_shard_b_contract() -> None:
...
def test_phase193_safety_locks_remain_closed() -> None:
    payload = load_phase193_artifact(ARTIFACT_PATH)
