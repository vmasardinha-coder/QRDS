...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build QRDS Phase 29 Compressed Regime Edge Retest Pack.")
    parser.add_argument("--output-dir", required=True)
    parser.add_argument("--repo-root", default="")
    args = parser.parse_args(argv)
    result = build_phase29_compressed_regime_edge_retest_pack(Path(args.output_dir), args.repo_root or None)
