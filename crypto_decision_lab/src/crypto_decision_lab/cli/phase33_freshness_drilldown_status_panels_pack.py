...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build QRDS Phase 33 Freshness + Drilldown Status Panels Pack.")
    parser.add_argument("--output-dir", required=True)
    parser.add_argument("--repo-root", default="")
    args = parser.parse_args(argv)
    result = build_phase33_freshness_drilldown_status_panels_pack(Path(args.output_dir), args.repo_root or None)
