...
def main(argv=None):
    p = argparse.ArgumentParser(description="Build QRDS Phase 12 Public Data Research Readiness Certification Pack.")
    p.add_argument("--output-dir", required=True)
    p.add_argument("--repo-root", default="")
    a = p.parse_args(argv)
    r = build_phase12_public_data_research_readiness_certification_pack(Path(a.output_dir), a.repo_root or None)
