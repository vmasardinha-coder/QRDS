...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build QRDS Phase 22 Model Performance Triage Research Gate Pack.")
    parser.add_argument("--output-dir", required=True)
    parser.add_argument("--repo-root", default="")
    args = parser.parse_args(argv)
    result = build_phase22_model_performance_triage_research_gate_pack(Path(args.output_dir), args.repo_root or None)
