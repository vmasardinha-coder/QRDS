...
echo "[QRDS][Phase56] Running focused tests..."
python -m pytest tests/unit/test_phase56_research_promotion_gate_checklist_research_only.py -q
echo "[QRDS][Phase56] Running full suite..."
python -m pytest -q
echo "PHASE56_RESEARCH_PROMOTION_GATE_CHECKLIST_RESEARCH_ONLY_READY_RESEARCH_ONLY"
