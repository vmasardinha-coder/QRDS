...
echo "[QRDS][Phase51] Running focused tests..."
python -m pytest tests/unit/test_phase51_validation_automation_harness.py -q
echo "[QRDS][Phase51] Running full suite..."
python -m pytest -q
echo "PHASE51_VALIDATION_AUTOMATION_HARNESS_READY_RESEARCH_ONLY"
