...
if [[ ! -f "$SERVE_DIR/index.html" ]]; then
  echo "[QRDS 8U] ERROR: expected $SERVE_DIR/index.html" >&2
  exit 1
fi
...
echo
echo "[QRDS 8U] Risk Model Gate site ready."
echo "[QRDS 8U] Serve directory: $SERVE_DIR"
echo "[QRDS 8U] Port: $PORT"
echo
echo "Codespaces:"
