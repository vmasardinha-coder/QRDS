# GATE BTC — Shadow Executive — 2026-09-15

**Status:** COMPLETE_WITH_EXPLICIT_ND  
**Reference data:** 2026-09-14  
...
```json
{
  "b3_h1": {
    ...
    "expected_session_weekday_proxy": "2026-09-14",
    "freshness": "STALE",
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-14",
    "freshness": "FRESH",
    "lag_days": 0,
  ...
  "gateway": {
    "freshness": "FRESH",
    "latest_source_data_as_of": "2026-09-15",
    "source": "runtime/ledgers/gateway_dynamics/STATUS.json",
    "status": "ACTIVE",
    "target": 80,
    "valid_snapshot_count": 41
  },
  "qos_monthly": {
    "current": 1,
    "expected_closes": [
...
```json
{
  ...
  "momentum": {
    ...
    "last_run_state": null,
    "m1_summary": {
      "breadth_pct_m1_gt_zero": 34.065934065934066,
      "cross_sectional_dispersion_m1": 0.7579903504865585,
      "cutoff": "2026-09-14",
      "delta_breadth_pct_points": 11.239847109412327,
      "engine_feed": false,
      "lookback_14_date": "2026-08-31",
      "lookback_30_date": "2026-08-15",
      "median_m1": -0.16976740159713188,
      "negative_median_distance_to_zero": 0.35871094438957074,
      "orders": 0,
      "real_capital": 0,
    ...
    "m2_summary": {
      "breadth_pct_m2_gt_zero": 17.582417582417584,
      "cross_sectional_dispersion_m2": 3.3235213698939643,
      "cutoff": "2026-09-14",
      "delta_breadth_pct_points": -11.76540850453894,
      "engine_feed": false,
      "excluded_incomplete_history": 2,
      "median_m2": -2.381405002255307,
      "orders": 0,
      "real_capital": 0,
      "reference_calendar": "BTC_COMPLETED_UTC_DAILY_BARS",
      "reference_window_bars": 31,
      "reference_window_end": "2026-09-14",
      "reference_window_start": "2026-08-15",
      "status": "PROSPECTIVE_SHADOW_ONLY_NOT_APPROVED",
      "universe_n": 91
    },
    "methodology_failure": null,
    "observed_snapshots": 21,
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "64d00539a1e798cedccac395fadac99cb6bafebfb11a42b52231b3056652b23d",
    ...
    "momentum_m3": {
      ...
      "records": {
        "momentum_m3": {
          ...
          "sha256": "aec40fc8bcb1bf65207bc81270b85fb06b4571857c30d9f5c5e6e463841c08cf",
    ...
    "v12": {
      ...
      "records": {
        "delta_v12_engine": {
          ...
          "sha256": "d7a12ef1ac47ec29f240493cf04e2b1405b6f17e3dfb50cb354199420cf388fa",
        ...
        "delta_v12_prices": {
          ...
          "sha256": "420f5d5016d405f7860b72ee094256d20a5c114b7c3c5d563ce0592f1c41e937",
