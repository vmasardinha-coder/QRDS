# GATE BTC — Shadow Executive — 2026-09-24

**Status:** COMPLETE_WITH_EXPLICIT_ND  
**Reference data:** 2026-09-23  
...
```json
{
  "b3_h1": {
    ...
    "expected_session_weekday_proxy": "2026-09-23",
    "freshness": "STALE",
  ...
  "v16b1": {
    ...
    "records": {
      "v16b1": {
        ...
        "sha256": "607a9e490789cbaa2cb5ece681045736a57afb51cd9d5e487d03b5bb4729b0c3",
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-23",
    "freshness": "FRESH",
    "lag_days": 0,
  ...
  "gateway": {
    "freshness": "FRESH",
    "latest_source_data_as_of": "2026-09-24",
    "source": "runtime/ledgers/gateway_dynamics/STATUS.json",
    "status": "ACTIVE",
    "target": 80,
    "valid_snapshot_count": 49
  },
  "qos_monthly": {
    "current": 1,
    "expected_closes": [
...
```json
{
  ...
  "momentum": {
    ...
    "last_run_state": null,
    "m1_summary": {
      "breadth_pct_m1_gt_zero": 38.70967741935484,
      "cross_sectional_dispersion_m1": 0.7813928459809183,
      "cutoff": "2026-09-23",
      "delta_breadth_pct_points": 1.0752688172043037,
      "engine_feed": false,
      "lookback_14_date": "2026-09-09",
      "lookback_30_date": "2026-08-24",
      "median_m1": -0.19228265013253706,
      "negative_median_distance_to_zero": 0.4035945532573403,
      "orders": 0,
      "real_capital": 0,
    ...
    "m2_summary": {
      "breadth_pct_m2_gt_zero": 47.31182795698925,
      "cross_sectional_dispersion_m2": 3.0566100812486137,
      "cutoff": "2026-09-23",
      "delta_breadth_pct_points": 11.827956989247312,
      "engine_feed": false,
      "excluded_incomplete_history": 2,
      "median_m2": -0.10051955816151659,
      "orders": 0,
      "real_capital": 0,
      "reference_calendar": "BTC_COMPLETED_UTC_DAILY_BARS",
      "reference_window_bars": 31,
      "reference_window_end": "2026-09-23",
      "reference_window_start": "2026-08-24",
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "b1b98fd497c057e335f401c19cfab162f1f29485d572a6c3cbac6a40c88989b6",
    ...
    "momentum_m3": {
      ...
      "records": {
        "momentum_m3": {
          ...
          "observed_snapshots": 12,
          "schema": "gate_btc.momentum_m3.status.v1",
          "sha256": "7dea747b8941ee7c2dd549161ed8e64ee5c5f0d1ed11ecdb604333b21a8e6da9",
    ...
    "v12": {
      ...
      "records": {
        ...
        "delta_v12_prices": {
          ...
          "sha256": "d9c518e3b84f81a4fa9b485129077654a82fde5af0695cb73c10755b81bb7a28",
