# GATE BTC — Shadow Executive — 2026-09-26

**Status:** COMPLETE_WITH_EXPLICIT_ND  
**Reference data:** 2026-09-25  
...
```json
{
  "b3_h1": {
    ...
    "expected_session_weekday_proxy": "2026-09-25",
    "freshness": "STALE",
  ...
  "v16b1": {
    ...
    "records": {
      "v16b1": {
        ...
        "sha256": "a7c5c981fe39e1406cd4275217f623e4d40b1d06c2b4e8bb9f1ecd3bce838cac",
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-25",
    "freshness": "FRESH",
    "lag_days": 0,
  ...
  "gateway": {
    "freshness": "FRESH",
    "latest_source_data_as_of": "2026-09-26",
    "source": "runtime/ledgers/gateway_dynamics/STATUS.json",
    "status": "ACTIVE",
    "target": 80,
    "valid_snapshot_count": 51
  },
  "qos_monthly": {
    "current": 1,
    "expected_closes": [
...
```json
{
  ...
  "momentum": {
    ...
    "last_run_state": null,
    "m1_summary": {
      "breadth_pct_m1_gt_zero": 37.89473684210526,
      "cross_sectional_dispersion_m1": 0.7847768546185611,
      "cutoff": "2026-09-25",
      "delta_breadth_pct_points": -0.8149405772495797,
      "engine_feed": false,
      "lookback_14_date": "2026-09-11",
      "lookback_30_date": "2026-08-26",
      "median_m1": -0.1756354958049526,
      "negative_median_distance_to_zero": 0.40732566901313116,
      "orders": 0,
      "real_capital": 0,
    ...
    "m2_summary": {
      "breadth_pct_m2_gt_zero": 73.6842105263158,
      "cross_sectional_dispersion_m2": 3.431791992697302,
      "cutoff": "2026-09-25",
      "delta_breadth_pct_points": 10.243350311262034,
      "engine_feed": false,
      "excluded_incomplete_history": 2,
      "median_m2": 1.8120719482257408,
      "orders": 0,
      "real_capital": 0,
      "reference_calendar": "BTC_COMPLETED_UTC_DAILY_BARS",
      "reference_window_bars": 31,
      "reference_window_end": "2026-09-25",
      "reference_window_start": "2026-08-26",
      "status": "PROSPECTIVE_SHADOW_ONLY_NOT_APPROVED",
      "universe_n": 95
    },
    "methodology_failure": null,
    "observed_snapshots": 32,
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "83c6c87bfec45e31dda31cf45c47e11af51f7e99022807e57edd94f31c21409e",
    ...
    "momentum_m3": {
      ...
      "records": {
        "momentum_m3": {
          ...
          "sha256": "3a90a2d50be8940fa1e2ba00a4f87d9b3a2b482976210cb6f6b293342b0bc21e",
    ...
    "v12": {
      ...
      "records": {
        ...
        "delta_v12_prices": {
          ...
          "sha256": "96a07640291aed7a9bdd5d6a42f07ee3194baf1ee0f8da07093bb060e052b759",
