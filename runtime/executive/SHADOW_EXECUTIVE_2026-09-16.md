# GATE BTC — Shadow Executive — 2026-09-16

**Status:** COMPLETE_WITH_EXPLICIT_ND  
**Reference data:** 2026-09-15  
...
```json
{
  "b3_h1": {
    ...
    "expected_session_weekday_proxy": "2026-09-15",
    "freshness": "STALE",
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-15",
    "freshness": "FRESH",
    "lag_days": 0,
  ...
  "gateway": {
    "freshness": "FRESH",
    "latest_source_data_as_of": "2026-09-16",
    "source": "runtime/ledgers/gateway_dynamics/STATUS.json",
    "status": "ACTIVE",
    "target": 80,
    "valid_snapshot_count": 42
  },
  "qos_monthly": {
    "current": 1,
    "expected_closes": [
...
```json
{
  ...
  "momentum": {
    ...
    "last_run_state": null,
    "m1_summary": {
      "breadth_pct_m1_gt_zero": 34.831460674157306,
      "cross_sectional_dispersion_m1": 0.7501933320124742,
      "cutoff": "2026-09-15",
      "delta_breadth_pct_points": 0.7655266082232401,
      "engine_feed": false,
      "lookback_14_date": "2026-09-01",
      "lookback_30_date": "2026-08-16",
      "median_m1": -0.1569536983876662,
      "negative_median_distance_to_zero": 0.37173238091557903,
      "orders": 0,
      "real_capital": 0,
    ...
    "m2_summary": {
      "breadth_pct_m2_gt_zero": 15.730337078651685,
      "cross_sectional_dispersion_m2": 2.8349025850277187,
      "cutoff": "2026-09-15",
      "delta_breadth_pct_points": -1.8520805037658992,
      "engine_feed": false,
      "excluded_incomplete_history": 2,
      "median_m2": -2.1353720690764737,
      "orders": 0,
      "real_capital": 0,
      "reference_calendar": "BTC_COMPLETED_UTC_DAILY_BARS",
      "reference_window_bars": 31,
      "reference_window_end": "2026-09-15",
      "reference_window_start": "2026-08-16",
      "status": "PROSPECTIVE_SHADOW_ONLY_NOT_APPROVED",
      "universe_n": 89
    },
    "methodology_failure": null,
    "observed_snapshots": 22,
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "e58f4405e549329cbcda4caf610564186c5d0a873b2614780a47614bb9058353",
    ...
    "momentum_m3": {
      ...
      "records": {
        "momentum_m3": {
          ...
          "sha256": "8b2f6ac0cfc9bd5757fb4608ef55741316b7c151ae35e5044770416c2ada132d",
    ...
    "v12": {
      ...
      "records": {
        "delta_v12_engine": {
          ...
          "sha256": "d86a899d76bffce41eec1e748a7600de74ca2d45a9912232e2286fcca81f6114",
        ...
        "delta_v12_prices": {
          ...
          "sha256": "a0261d258a6d34e3fc8d80f9979b93781f496256d97054fc6826b6ad34833c50",
