# GATE BTC — Shadow Executive — 2026-09-22

**Status:** COMPLETE_WITH_EXPLICIT_ND  
**Reference data:** 2026-09-21  
...
```json
{
  "b3_h1": {
    ...
    "expected_session_weekday_proxy": "2026-09-21",
    "freshness": "STALE",
  ...
  "v16b1": {
    ...
    "records": {
      "v16b1": {
        ...
        "sha256": "8546d6da856bf6bc525357bdc0134ce2b954530b2a47fb806b9b30ea8fb7114e",
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-21",
    "freshness": "FRESH",
    "lag_days": 0,
  ...
  "gateway": {
    "freshness": "FRESH",
    "latest_source_data_as_of": "2026-09-22",
    "source": "runtime/ledgers/gateway_dynamics/STATUS.json",
    "status": "ACTIVE",
    "target": 80,
    "valid_snapshot_count": 47
  },
  "qos_monthly": {
    "current": 1,
    "expected_closes": [
...
```json
{
  ...
  "momentum": {
    ...
    "last_run_state": null,
    "m1_summary": {
      "breadth_pct_m1_gt_zero": 32.608695652173914,
      "cross_sectional_dispersion_m1": 0.7850206327390294,
      "cutoff": "2026-09-21",
      "delta_breadth_pct_points": -2.556139512661254,
      "engine_feed": false,
      "lookback_14_date": "2026-09-07",
      "lookback_30_date": "2026-08-22",
      "median_m1": -0.19226924652166405,
      "negative_median_distance_to_zero": 0.34170168815104096,
      "orders": 0,
      "real_capital": 0,
    ...
    "m2_summary": {
      "breadth_pct_m2_gt_zero": 23.91304347826087,
      "cross_sectional_dispersion_m2": 3.1162938952292563,
      "cutoff": "2026-09-21",
      "delta_breadth_pct_points": -40.92212135690396,
      "engine_feed": false,
      "excluded_incomplete_history": 2,
      "median_m2": -1.61979897017232,
      "orders": 0,
      "real_capital": 0,
      "reference_calendar": "BTC_COMPLETED_UTC_DAILY_BARS",
      "reference_window_bars": 31,
      "reference_window_end": "2026-09-21",
      "reference_window_start": "2026-08-22",
      "status": "PROSPECTIVE_SHADOW_ONLY_NOT_APPROVED",
      "universe_n": 92
    },
    "methodology_failure": null,
    "observed_snapshots": 28,
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "0a0f20b5e83320c85afd1a3e354a40afa1136fb707ef573716f6b53fa1c47e74",
    ...
    "momentum_m3": {
      ...
      "records": {
        "momentum_m3": {
          ...
          "observed_snapshots": 10,
          "schema": "gate_btc.momentum_m3.status.v1",
          "sha256": "89fb75c0f3b9185b9176fb51c0ffed7feb355240a6146a544ec492032aceaf46",
    ...
    "v12": {
      ...
      "records": {
        ...
        "delta_v12_prices": {
          ...
          "sha256": "72ff8f2e18ccc04ae71cae9c5f42d37d6f66a8371ddee49b4851cbe08541e4ff",
