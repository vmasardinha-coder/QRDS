# GATE BTC — Shadow Executive — 2026-09-23

**Status:** COMPLETE_WITH_EXPLICIT_ND  
**Reference data:** 2026-09-22  
...
```json
{
  "b3_h1": {
    ...
    "expected_session_weekday_proxy": "2026-09-22",
    "freshness": "STALE",
  ...
  "v16b1": {
    ...
    "records": {
      "v16b1": {
        ...
        "sha256": "d05594b2eeb1edb4fb636c43c4ac8d4416e465d5dc72766e1cbb76114878edf5",
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-22",
    "freshness": "FRESH",
    "lag_days": 0,
  ...
  "gateway": {
    "freshness": "FRESH",
    "latest_source_data_as_of": "2026-09-23",
    "source": "runtime/ledgers/gateway_dynamics/STATUS.json",
    "status": "ACTIVE",
    "target": 80,
    "valid_snapshot_count": 48
  },
  "qos_monthly": {
    "current": 1,
    "expected_closes": [
...
```json
{
  ...
  "momentum": {
    ...
    "last_run_state": null,
    "m1_summary": {
      "breadth_pct_m1_gt_zero": 37.634408602150536,
      "cross_sectional_dispersion_m1": 0.7856805357521854,
      "cutoff": "2026-09-22",
      "delta_breadth_pct_points": 5.025712949976622,
      "engine_feed": false,
      "lookback_14_date": "2026-09-08",
      "lookback_30_date": "2026-08-23",
      "median_m1": -0.2152835713961993,
      "negative_median_distance_to_zero": 0.3778379277863707,
      "orders": 0,
      "real_capital": 0,
    ...
    "m2_summary": {
      "breadth_pct_m2_gt_zero": 35.483870967741936,
      "cross_sectional_dispersion_m2": 3.003030967671718,
      "cutoff": "2026-09-22",
      "delta_breadth_pct_points": 11.570827489481065,
      "engine_feed": false,
      "excluded_incomplete_history": 2,
      "median_m2": -0.6092891903293411,
      "orders": 0,
      "real_capital": 0,
      "reference_calendar": "BTC_COMPLETED_UTC_DAILY_BARS",
      "reference_window_bars": 31,
      "reference_window_end": "2026-09-22",
      "reference_window_start": "2026-08-23",
      "status": "PROSPECTIVE_SHADOW_ONLY_NOT_APPROVED",
      "universe_n": 93
    },
    "methodology_failure": null,
    "observed_snapshots": 29,
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "5b0d3dec1672521bb8c882da261ceef12d61709f5c6c3a30ac2d16e21ee8d893",
    ...
    "momentum_m3": {
      ...
      "records": {
        "momentum_m3": {
          ...
          "observed_snapshots": 11,
          "schema": "gate_btc.momentum_m3.status.v1",
          "sha256": "29b5c5a04175c0e90bc7db5934fabbdcb3bb40ba8092e45f38854789678546cc",
    ...
    "v12": {
      ...
      "records": {
        ...
        "delta_v12_prices": {
          ...
          "sha256": "4369ced41bd5b4a449170338efad016e5056adbe530e7f80ce54867ec8ebf2b1",
