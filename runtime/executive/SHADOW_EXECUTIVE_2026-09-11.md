# GATE BTC — Shadow Executive — 2026-09-11

**Status:** COMPLETE_WITH_EXPLICIT_ND  
**Reference data:** 2026-09-10  
...
```json
{
  "b3_h1": {
    ...
    "expected_session_weekday_proxy": "2026-09-10",
    "freshness": "STALE",
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-10",
    "freshness": "FRESH",
    "lag_days": 0,
  ...
  "gateway": {
    "freshness": "FRESH",
    "latest_source_data_as_of": "2026-09-11",
    "source": "runtime/ledgers/gateway_dynamics/STATUS.json",
    "status": "ACTIVE",
    "target": 80,
    "valid_snapshot_count": 37
  },
  "qos_monthly": {
    "current": 1,
    "expected_closes": [
...
```json
{
  ...
  "momentum": {
    ...
    "m1_summary": {
      ...
      "cross_sectional_dispersion_m1": 0.7718890204253843,
      "cutoff": "2026-09-10",
      "delta_breadth_pct_points": 0.0,
      "engine_feed": false,
      "lookback_14_date": "2026-08-27",
      "lookback_30_date": "2026-08-11",
      "median_m1": -0.19655159288323798,
      "negative_median_distance_to_zero": 0.3787904607197029,
      "orders": 0,
      "real_capital": 0,
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "a1a0a6753acf56c47e8c63280c0cfb794b743d217db4392879ba73954b89cc25",
    ...
    "v12": {
      ...
      "records": {
        "delta_v12_engine": {
          ...
          "sha256": "7918e41c50794bbe18cab57edd5b78adfefea2c60aa2eaf884a679b137d44c16",
        ...
        "delta_v12_prices": {
          ...
          "sha256": "5053e06299226d603dcee17890b82139925556a0602556f1a82ed134caffb4b6",
