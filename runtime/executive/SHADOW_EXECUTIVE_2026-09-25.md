# GATE BTC — Shadow Executive — 2026-09-25
...
```json
{
  "b3_h1": {
    ...
    "expected_session_weekday_proxy": "2026-09-24",
    "freshness": "STALE",
  ...
  "v16b1": {
    ...
    "records": {
      "v16b1": {
        ...
        "sha256": "7c193c60140afb1a87874a92ea9013c46eac22772787d5c778bac098957955cd",
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-24",
    "freshness": "FRESH",
    "lag_days": 0,
  ...
  "gateway": {
    "freshness": "FRESH",
    "latest_source_data_as_of": "2026-09-25",
    "source": "runtime/ledgers/gateway_dynamics/STATUS.json",
    "status": "ACTIVE",
    "target": 80,
    "valid_snapshot_count": 50
  },
  "qos_monthly": {
    "current": 1,
    "expected_closes": [
...
```json
{
  ...
  "momentum": {
    ...
    "m1_summary": {
      ...
      "cross_sectional_dispersion_m1": 0.7851228919784259,
      "cutoff": "2026-09-24",
      "delta_breadth_pct_points": 0.0,
      "engine_feed": false,
      "lookback_14_date": "2026-09-10",
      "lookback_30_date": "2026-08-25",
      "median_m1": -0.18443160022124966,
      "negative_median_distance_to_zero": 0.441831205065054,
      "orders": 0,
      "real_capital": 0,
    ...
    "m2_summary": {
      "breadth_pct_m2_gt_zero": 63.44086021505376,
      "cross_sectional_dispersion_m2": 3.3033435210927693,
      "cutoff": "2026-09-24",
      "delta_breadth_pct_points": 16.129032258064512,
      "engine_feed": false,
      "excluded_incomplete_history": 2,
      "median_m2": 1.1761345293204108,
      "orders": 0,
      "real_capital": 0,
      "reference_calendar": "BTC_COMPLETED_UTC_DAILY_BARS",
      "reference_window_bars": 31,
      "reference_window_end": "2026-09-24",
      "reference_window_start": "2026-08-25",
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "06cf7b2b830c529d2af234b7bc0ac1d5226e15450c60034806f34e1ec359d45c",
    ...
    "momentum_m3": {
      ...
      "records": {
        "momentum_m3": {
          ...
          "observed_snapshots": 13,
          "schema": "gate_btc.momentum_m3.status.v1",
          "sha256": "8f16243f7240fccc5c79f4cc0a39a55b59f23800efb1aaadfd1f047ec9aea2f8",
    ...
    "v12": {
      ...
      "records": {
        ...
        "delta_v12_prices": {
          ...
          "sha256": "d11aa44314bbd0017948125fddb755dc33fedf1f57cfbfebd07d3dae0c21d71b",
