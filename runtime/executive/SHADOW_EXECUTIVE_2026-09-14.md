# GATE BTC — Shadow Executive — 2026-09-14

**Status:** COMPLETE_WITH_EXPLICIT_ND  
**Reference data:** 2026-09-13  
...
```json
{
  "b3_h1": {
    ...
    "expected_session_weekday_proxy": "2026-09-11",
    "freshness": "STALE",
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-13",
    "freshness": "FRESH",
    "lag_days": 0,
  ...
  "gateway": {
    "freshness": "FRESH",
    "latest_source_data_as_of": "2026-09-14",
    "source": "runtime/ledgers/gateway_dynamics/STATUS.json",
    "status": "ACTIVE",
    "target": 80,
    "valid_snapshot_count": 40
  },
  "qos_monthly": {
    "current": 1,
    "expected_closes": [
...
```json
{
  ...
  "momentum": {
    ...
    "last_run_state": null,
    "m1_summary": {
      "breadth_pct_m1_gt_zero": 22.82608695652174,
      "cross_sectional_dispersion_m1": 0.8139579310361588,
      "cutoff": "2026-09-13",
      "delta_breadth_pct_points": -13.128969223253545,
      "engine_feed": false,
      "lookback_14_date": "2026-08-30",
      "lookback_30_date": "2026-08-14",
      "median_m1": -0.12586055586726813,
      "negative_median_distance_to_zero": 0.1539664507070958,
      "orders": 0,
      "real_capital": 0,
    ...
    "m2_summary": {
      "breadth_pct_m2_gt_zero": 29.347826086956523,
      "cross_sectional_dispersion_m2": 3.467295545381605,
      "cutoff": "2026-09-13",
      "delta_breadth_pct_points": 3.505129457743042,
      "engine_feed": false,
      "excluded_incomplete_history": 2,
      "median_m2": -1.6017977685238902,
      "orders": 0,
      "real_capital": 0,
      "reference_calendar": "BTC_COMPLETED_UTC_DAILY_BARS",
      "reference_window_bars": 31,
      "reference_window_end": "2026-09-13",
      "reference_window_start": "2026-08-14",
      "status": "PROSPECTIVE_SHADOW_ONLY_NOT_APPROVED",
      "universe_n": 92
    },
    "methodology_failure": null,
    "observed_snapshots": 20,
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "08986061c435ad8d86ed08facc517ff3f44c157b4faf76fcc9bef834451baafa",
    ...
    "momentum_m3": {
      ...
      "records": {
        "momentum_m3": {
          ...
          "sha256": "b64e6f0722fb083e83abce4380a21ec0b13b54248a96711cd7248ad0c170915b",
    ...
    "v12": {
      ...
      "records": {
        "delta_v12_engine": {
          ...
          "sha256": "ced4c2cb1dbae581764a065a187fe422795e5786c3e36743d73cae681baae3ff",
        ...
        "delta_v12_prices": {
          ...
          "sha256": "2a374cf5b9b87822772b75ddf777f06e4ef2b48ea18cf5313b0d8e68ffb50da4",
