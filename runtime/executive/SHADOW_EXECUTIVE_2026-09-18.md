# GATE BTC — Shadow Executive — 2026-09-18

**Status:** COMPLETE_WITH_EXPLICIT_ND  
**Reference data:** 2026-09-17  
...
```json
{
  "b3_h1": {
    ...
    "expected_session_weekday_proxy": "2026-09-17",
    "freshness": "STALE",
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-17",
    "freshness": "FRESH",
    "lag_days": 0,
...
```json
{
  ...
  "momentum": {
    ...
    "last_run_state": null,
    "m1_summary": {
      "breadth_pct_m1_gt_zero": 33.70786516853933,
      "cross_sectional_dispersion_m1": 0.770545601204294,
      "cutoff": "2026-09-17",
      "delta_breadth_pct_points": 6.435137895812055,
      "engine_feed": false,
      "lookback_14_date": "2026-09-03",
      "lookback_30_date": "2026-08-18",
      "median_m1": -0.2228493288362263,
      "negative_median_distance_to_zero": 0.3594561224513379,
      "orders": 0,
      "real_capital": 0,
    ...
    "m2_summary": {
      "breadth_pct_m2_gt_zero": 56.17977528089887,
      "cross_sectional_dispersion_m2": 3.254701733122295,
      "cutoff": "2026-09-17",
      "delta_breadth_pct_points": 33.45250255362615,
      "engine_feed": false,
      "excluded_incomplete_history": 2,
      "median_m2": 0.447487058501162,
      "orders": 0,
      "real_capital": 0,
      "reference_calendar": "BTC_COMPLETED_UTC_DAILY_BARS",
      "reference_window_bars": 31,
      "reference_window_end": "2026-09-17",
      "reference_window_start": "2026-08-18",
      "status": "PROSPECTIVE_SHADOW_ONLY_NOT_APPROVED",
      "universe_n": 89
    },
    "methodology_failure": null,
    "observed_snapshots": 24,
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "640fc8aa3bbd003045b08a68ac86e5aedd0ef8db094980983af1b8f2b21eeb48",
    ...
    "momentum_m3": {
      ...
      "records": {
        "momentum_m3": {
          ...
          "observed_snapshots": 7,
          "schema": "gate_btc.momentum_m3.status.v1",
          "sha256": "11c1798a85687cc0e88263dc8a9f6fec04f2519b47c9132cb70c962d8e3cb764",
    ...
    "v12": {
      ...
      "records": {
        "delta_v12_engine": {
          ...
          "sha256": "3af4febbd41d1abe825c928e61c973c393f5108a01266456feff94cb0e6c646d",
        ...
        "delta_v12_prices": {
          ...
          "sha256": "0b7e08b074cbc24b19543586f5910ee8c5b72b91fdb4749cbd6c40b6023f83d7",
