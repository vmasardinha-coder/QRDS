# GATE BTC — Shadow Executive — 2026-09-17

**Status:** COMPLETE_WITH_EXPLICIT_ND  
**Reference data:** 2026-09-16  
...
```json
{
  "b3_h1": {
    ...
    "expected_session_weekday_proxy": "2026-09-16",
    "freshness": "STALE",
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-16",
    "freshness": "FRESH",
    "lag_days": 0,
  ...
  "gateway": {
    "freshness": "FRESH",
    "latest_source_data_as_of": "2026-09-17",
    "source": "runtime/ledgers/gateway_dynamics/STATUS.json",
    "status": "ACTIVE",
    "target": 80,
    "valid_snapshot_count": 43
  },
  "qos_monthly": {
    "current": 1,
    "expected_closes": [
...
```json
{
  ...
  "momentum": {
    ...
    "last_run_state": null,
    "m1_summary": {
      "breadth_pct_m1_gt_zero": 27.272727272727273,
      "cross_sectional_dispersion_m1": 0.7675523232319045,
      "cutoff": "2026-09-16",
      "delta_breadth_pct_points": -7.5587334014300325,
      "engine_feed": false,
      "lookback_14_date": "2026-09-02",
      "lookback_30_date": "2026-08-17",
      "median_m1": -0.16110500106844622,
      "negative_median_distance_to_zero": 0.28781782058967964,
      "orders": 0,
      "real_capital": 0,
    ...
    "m2_summary": {
      "breadth_pct_m2_gt_zero": 22.727272727272727,
      "cross_sectional_dispersion_m2": 3.0246958965636312,
      "cutoff": "2026-09-16",
      "delta_breadth_pct_points": 6.996935648621042,
      "engine_feed": false,
      "excluded_incomplete_history": 2,
      "median_m2": -1.611533291841358,
      "orders": 0,
      "real_capital": 0,
      "reference_calendar": "BTC_COMPLETED_UTC_DAILY_BARS",
      "reference_window_bars": 31,
      "reference_window_end": "2026-09-16",
      "reference_window_start": "2026-08-17",
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "c5ce2443ed29615c01662b13ac2f0271fb9531ba50be8dfb705bea8b15ad9609",
    ...
    "momentum_m3": {
      ...
      "records": {
        "momentum_m3": {
          ...
          "observed_snapshots": 6,
          "schema": "gate_btc.momentum_m3.status.v1",
          "sha256": "448ea1296b828fa6a38368f04114c532b61d887be9cd6dff7b2d9658db8c6ce9",
    ...
    "v12": {
      ...
      "records": {
        "delta_v12_engine": {
          ...
          "sha256": "76e26eb0cd352776352f2a1100e63cc098cd22b9f485d79a48ffea6424a50a64",
        ...
        "delta_v12_prices": {
          ...
          "sha256": "cd2e38924e91da18b3e546384685193b536ee81ea89b03c0de69dd2c73ff7b01",
