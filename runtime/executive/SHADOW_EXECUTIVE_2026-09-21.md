# GATE BTC — Shadow Executive — 2026-09-21

**Status:** COMPLETE_WITH_EXPLICIT_ND  
**Reference data:** 2026-09-18  
...
```json
{
  "b3_h1": {
    ...
    "expected_session_weekday_proxy": "2026-09-18",
    "freshness": "STALE",
  ...
  "v16b1": {
    ...
    "records": {
      "v16b1": {
        ...
        "sha256": "c34030ffd610442277894a7f796f955e969de4d992889a617795d28e10d16377",
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-20",
    "freshness": "STALE",
    "lag_days": 2,
    "source": "runtime/GATE_BTC_LATEST_ELIGIBLE_RUN.json",
    "status": "LATE_MISSING_OR_INVALID"
  },
  "delta_observations": {
    "source": "runtime/GATE_BTC_MEASUREMENT_STATUS.json",
    "status": "PRESENT",
  ...
  "gateway": {
    "freshness": "FRESH",
    "latest_source_data_as_of": "2026-09-18",
    "source": "runtime/ledgers/gateway_dynamics/STATUS.json",
    "status": "ACTIVE",
    "target": 80,
    "valid_snapshot_count": 44
  },
  "qos_monthly": {
    "current": 1,
    "expected_closes": [
...
```json
{
  ...
  "momentum": {
    ...
    "last_run_state": null,
    "m1_summary": {
      "breadth_pct_m1_gt_zero": 35.16483516483517,
      "cross_sectional_dispersion_m1": 0.7797042266187562,
      "cutoff": "2026-09-20",
      "delta_breadth_pct_points": 5.164835164835168,
      "engine_feed": false,
      "lookback_14_date": "2026-09-06",
      "lookback_30_date": "2026-08-21",
      "median_m1": -0.2565633540589303,
      "negative_median_distance_to_zero": 0.4427286873620659,
      "orders": 0,
      "real_capital": 0,
    ...
    "m2_summary": {
      "breadth_pct_m2_gt_zero": 64.83516483516483,
      "cross_sectional_dispersion_m2": 3.1396870348834955,
      "cutoff": "2026-09-20",
      "delta_breadth_pct_points": 28.168498168498168,
      "engine_feed": false,
      "excluded_incomplete_history": 2,
      "median_m2": 0.9613938190295974,
      "orders": 0,
      "real_capital": 0,
      "reference_calendar": "BTC_COMPLETED_UTC_DAILY_BARS",
      "reference_window_bars": 31,
      "reference_window_end": "2026-09-20",
      "reference_window_start": "2026-08-21",
      "status": "PROSPECTIVE_SHADOW_ONLY_NOT_APPROVED",
      "universe_n": 91
    },
    "methodology_failure": null,
    "observed_snapshots": 27,
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "712440f1c7bc3694459c512edd6b47433bcd30d255f06b8293ca061234b8d0ea",
    ...
    "momentum_m3": {
      ...
      "records": {
        "momentum_m3": {
          ...
          "sha256": "9a4ab34e073dfb3c5c58932ab3ba43c2b8e6b51b35c514f97ec318ed7d7b41af",
    ...
    "v12": {
      ...
      "records": {
        ...
        "delta_v12_prices": {
          ...
          "sha256": "6ba5515924564b043770ed488fbdb75798fc74b6aafc43466d6eab21abcf60af",
