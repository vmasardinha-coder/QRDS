# GATE BTC — Shadow Executive — 2026-09-12

**Status:** COMPLETE_WITH_EXPLICIT_ND  
**Reference data:** 2026-09-11  
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-11",
    "freshness": "FRESH",
    "lag_days": 0,
  ...
  "gateway": {
    "freshness": "FRESH",
    "latest_source_data_as_of": "2026-09-12",
    "source": "runtime/ledgers/gateway_dynamics/STATUS.json",
    "status": "ACTIVE",
    "target": 80,
    "valid_snapshot_count": 38
  },
  "qos_monthly": {
    "current": 1,
    "expected_closes": [
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "a3bc12cf8f26c7220f17e1dcb145212d134fcb9060b899dd5a8029d8f8e3fa4d",
    ...
    "momentum_m3": {
      ...
      "records": {
        "momentum_m3": {
          ...
          "sha256": "bf0365b9dc0f737d50a1f14c7a4e1da142f21af732aa6ef046e86da7a29c6639",
    ...
    "v12": {
      ...
      "records": {
        "delta_v12_engine": {
          ...
          "sha256": "7306326e630234ced4516eaba2b408c20d3113fee8db2835c0ed9edb7cb9d07b",
        ...
        "delta_v12_prices": {
          ...
          "sha256": "71534e38d63480a183421af338bcaf8b3af8946f8cc7bd1d5002b5247e4b592c",
