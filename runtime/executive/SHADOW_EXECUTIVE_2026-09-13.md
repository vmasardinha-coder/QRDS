# GATE BTC — Shadow Executive — 2026-09-13

**Status:** COMPLETE_WITH_EXPLICIT_ND  
**Reference data:** 2026-09-12  
...
```json
{
  ...
  "daily_delivery_pointer": {
    ...
    "expected_data_cutoff": "2026-09-12",
    "freshness": "FRESH",
    "lag_days": 0,
  ...
  "gateway": {
    "freshness": "FRESH",
    "latest_source_data_as_of": "2026-09-13",
    "source": "runtime/ledgers/gateway_dynamics/STATUS.json",
    "status": "ACTIVE",
    "target": 80,
    "valid_snapshot_count": 39
  },
  "qos_monthly": {
    "current": 1,
    "expected_closes": [
...
```json
{
  ...
  "momentum": {
    ...
    "last_run_state": null,
    "m1_summary": {
      "breadth_pct_m1_gt_zero": 35.95505617977528,
      "cross_sectional_dispersion_m1": 0.7757597521031013,
      "cutoff": "2026-09-12",
      "delta_breadth_pct_points": 0.0,
      "engine_feed": false,
      "lookback_14_date": "2026-08-29",
      "lookback_30_date": "2026-08-13",
      "median_m1": -0.19894355197537383,
      "negative_median_distance_to_zero": 0.3408519248175669,
      "orders": 0,
      "real_capital": 0,
    ...
    "m2_summary": {
      "breadth_pct_m2_gt_zero": 25.84269662921348,
      "cross_sectional_dispersion_m2": 2.9851995104776505,
      "cutoff": "2026-09-12",
      "delta_breadth_pct_points": 2.2471910112359517,
      "engine_feed": false,
      "excluded_incomplete_history": 2,
      "median_m2": -1.9101064619525514,
      "orders": 0,
      "real_capital": 0,
      "reference_calendar": "BTC_COMPLETED_UTC_DAILY_BARS",
      "reference_window_bars": 31,
      "reference_window_end": "2026-09-12",
      "reference_window_start": "2026-08-13",
      "status": "PROSPECTIVE_SHADOW_ONLY_NOT_APPROVED",
      "universe_n": 89
    },
    "methodology_failure": null,
    "observed_snapshots": 19,
    ...
    "d100": {
      ...
      "records": {
        "d100": {
          ...
          "sha256": "84cf014f60b8f5564e1ce2295644576f8e5f8742a24032383c539d16827b9d78",
    ...
    "momentum_m3": {
      ...
      "records": {
        "momentum_m3": {
          ...
          "sha256": "c3c774289ca550d28180d66246dc5d284dc472ef00d78b3b480f28e59b87f21c",
    ...
    "v12": {
      ...
      "records": {
        "delta_v12_engine": {
          ...
          "sha256": "f61a8e469a23debb061a148a62d8af16408f8e4982d37a65f0867b055323b4b3",
        ...
        "delta_v12_prices": {
          ...
          "sha256": "6000d02e6fdb165ee04fcda056ca55bda8941a4a4798979b3d2c43725fc8bd6e",
