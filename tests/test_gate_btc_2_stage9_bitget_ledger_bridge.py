...
class BitgetLedgerBridgeTests(unittest.TestCase):
    def _fixture(self, root: Path):
        ...
        capture={
            ...
            "captured_at_utc":"2026-08-30T02:12:08Z","roles":{"FUNDING":{},"OPEN_INTEREST":{},"PERP_VOLUME":{},"SPOT_VOLUME":{}},
        ...
        provider={
            ...
            "raw_roles":["FUNDING","OPEN_INTEREST","PERP_VOLUME","SPOT_VOLUME"],"captured_at_utc":"2026-08-30T02:12:08Z",
    ...
    def test_valid_bridge_emits_canonical_admission(self):
        with tempfile.TemporaryDirectory() as td:
            cap, adm=self._fixture(Path(td)); row=build_canonical_admission(cap, adm)
            validate_admission(row)
            self.assertEqual(row["run_id"], 33287403941)
    ...
    def test_raw_tamper_fails_closed(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            with self.assertRaises(RuntimeError): build_canonical_admission(cap, adm)
