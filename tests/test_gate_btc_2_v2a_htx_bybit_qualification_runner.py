...
from tools.gate_btc_2_v2a_htx_bybit_qualification_runner import parse_day
...
def test_parse_archive_schema_and_qa_pass():
    ...
    result = parse_day("HTXUSDT_2024-01-01.csv.gz", "2024-01-01", raw)
...
def test_unknown_schema_fails_closed():
    ...
    try:
        parse_day("HTXUSDT_2024-01-01.csv.gz", "2024-01-01", raw)
