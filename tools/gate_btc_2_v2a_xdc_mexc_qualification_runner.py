#!/usr/bin/env python3
"""Physical qualification-only capture for preregistered XDC/MEXC V2A source."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        default="artifacts/gate_btc_2/v2a_xdc_mexc_qualification",
    )
    ...
    try:
        ...
        if not rows:
            raise ValueError("no XDCUSDT historical candles returned")
    ...
    summary = {
        "schema_version": "GATE_BTC_2_V2A_XDC_MEXC_QUALIFICATION_V1",
        "issue": 111,
        "symbol": "XDC",
        "coin_id": "xdce-crowd-sale",
        "provider": PROVIDER,
        "market": "SPOT",
        "pair": PAIR,
        "source_surface": BASE,
