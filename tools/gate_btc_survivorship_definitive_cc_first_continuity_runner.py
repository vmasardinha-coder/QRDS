...
trade-level Bybit archive deferred, preserves the CryptoCompare fail-fast stage,
and adds only four primary-source documented identity continuities. No strategy,
factor, weight, price, return, execution, or frozen-engine rule is changed.
"""
