...
BASE = "https://public.bybit.com/spot/KCSUSDT/"
PAIR = "KCSUSDT"
PROVIDER = "Bybit"
DAY_RE = re.compile(r'href=["\'](KCSUSDT_(\d{4}-\d{2}-\d{2})\.csv\.gz)["\']')
...
def main() -> int:
    ...
    try:
        ...
        if not entries:
            raise ValueError("no exact KCSUSDT daily archive objects")
    ...
    summary = {
        "schema_version": "GATE_BTC_2_V2A_KCS_BYBIT_QUALIFICATION_V2_ARCHIVE",
        "issue": 111,
        "symbol": "KCS",
