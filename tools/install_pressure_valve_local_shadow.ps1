...
# The task calls only the isolated Pressure Valve collector. It does not invoke,
# stop, restart, inspect, or write the H1/H31 task or its spool.
...
# Prove H1/H31 task was not replaced or disabled. Read-only inspection only.
