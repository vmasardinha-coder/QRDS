#!/usr/bin/env python3
"""Physical qualification-only capture for preregistered SYRUP/Coinbase V2A source."""
...
def parse_product(raw: bytes) -> dict:
    ...
    if obj.get("base_currency") != "SYRUP" or obj.get("quote_currency") != "USD":
...
def main() -> int:
    ...
    parser.add_argument("--output", default="artifacts/gate_btc_2/v2a_syrup_coinbase_qualification")
    ...
    try:
        ...
        if not rows:
            raise ValueError("no SYRUP-USD historical candles returned")
    ...
    summary = {
        "schema_version": "GATE_BTC_2_V2A_SYRUP_COINBASE_QUALIFICATION_V1",
        "issue": 111,
        "symbol": "SYRUP",
        "coin_id": "maple-finance",
        "provider": PROVIDER,
        "market": "SPOT",
        "pair": PAIR,
