...
def main() -> int:
    ...
    source_gate={
      ...
      "B3_COTAHIST_OFFICIAL":{"physical_capture_pass":b3_reachable,"attempts":[public(x) for x in b3_attempts],"target_bytes_parsed":False,"target_outcomes_read":False,"pit_admission_pass":False,"status":"TARGET_PHYSICAL_CAPTURE_REACHABLE_UNPARSED" if b3_reachable else "TARGET_CAPTURE_FAIL"}}
