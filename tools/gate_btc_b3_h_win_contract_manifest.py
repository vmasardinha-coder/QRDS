...
B3_SOURCE = "https://arquivos.b3.com.br/rapinegocios/tickercsv/{date}"
...
def build_manifest(start: date=ALLOWED_START, end_exclusive: date=H1_CUTOFF) -> dict:
    ...
    for d in iter_weekdays(start,end_exclusive):
        ...
        rows.append({
            ...
            "source_url": B3_SOURCE.format(date=d.isoformat()),
            "status": "PRE_H1_ALLOWED_SOURCE_CANDIDATE",
        })
    return {
        "schema":"gate_btc.b3.h_nextgen.win_manifest.v1",
        ...
        "source":"B3 official tick-by-trade archive",
        "sessions":rows,
    }
