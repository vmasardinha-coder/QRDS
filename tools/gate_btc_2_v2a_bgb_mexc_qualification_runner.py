#!/usr/bin/env python3
"""Physical qualification-only capture for preregistered BGB/MEXC V2A source."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        default="artifacts/gate_btc_2/v2a_bgb_mexc_qualification",
    )
    ...
    try:
        ...
        if not rows:
            raise ValueError("no BGBUSDT historical candles returned")
    ...
    summary = {
        "schema_version": "GATE_BTC_2_V2A_BGB_MEXC_QUALIFICATION_V1",
        "issue": 111,
        "symbol": "BGB",
