#!/usr/bin/env python3
"""Fail-closed physical re-probe for preregistered SOFID on Kraken.

Qualification-only. Reuses the exact frozen #493 contract after a material change
in Kraken's public SOFID product surface. Discovers the exact public Kraken
asset/pair before reading OHLC. Raw responses and SHA-256 are preserved. No
source admission, D0, prospective/scientific credit, backfill, engine feed,
orders or capital.
"""
