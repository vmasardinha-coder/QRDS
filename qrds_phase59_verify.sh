...
echo "[QRDS][Phase59] Running focused tests..."
python -m pytest tests/unit/test_phase59_journal_replay_dry_run_manifest_research_only.py -q
echo "[QRDS][Phase59] Running full suite..."
python -m pytest -q
echo "PHASE59_JOURNAL_REPLAY_DRY_RUN_MANIFEST_RESEARCH_ONLY_READY_RESEARCH_ONLY"
